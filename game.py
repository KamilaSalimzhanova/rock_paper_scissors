...
class Rock(Object):
    def __init__(self, screen, x = None, y = None):
        self.screen = screen
        super().__init__(self.screen, "rock.png", x, y)
    
class Paper(Object):
    def __init__(self, screen, x = None, y = None):
        self.screen = screen
        super().__init__(self.screen, "paper.png",  x, y)     

class Scissors(Object):
    def __init__(self, screen, x = None, y = None):
        self.screen = screen
        super().__init__(self.screen, "scissors.png", x, y)   
...
pygame.mixer.music.load("mozart-serenade-in-g-major_kA99wY7u.mp3")
